...
def load_data(directory, extension='.features', delimiter=' ', split_at='-',
              max_classes=99999, min_instances=10, max_instances=500, pack_dataset=True):
    """
        ...
        for root, dirs, files in os.walk(directory):
            ...
            for file in files:
                ...
                with open(os.path.join(root, file), "r") as csvFile:
                    # print(os.path.join(root, file)) # N4L0_v24-03-30/pt-sup/0/95-47702.features
